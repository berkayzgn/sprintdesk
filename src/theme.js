...
export function themeVars(theme, style) {
  ...
  if (theme === 'dark') return {
    ...
    '--sidebar-active':   'rgba(155,109,255,.16)',
    '--sidebar-active-fg':'#dccbff',
    ...
    '--card-shadow-hover':'0 3px 12px rgba(0,0,0,.45)',
    '--text':             '#e9eaf4',
    '--text-muted':       '#9296b3',
    '--text-subtle':      '#6b6f8c',
    '--accent':           '#9b6dff',
  ...
  return {
    ...
    '--card-shadow-hover':A ? '0 3px 10px rgba(16,24,40,.10)' : '0 3px 10px rgba(99,102,241,.10)',
    '--text':             '#191b2c',
    '--text-muted':       '#6b7090',
    '--text-subtle':      '#9296b3',
    '--accent':           '#360185',
